...
export const fr: Dictionary = {
  ...
  preferences: {
    title: 'Préférences',
    open: 'Préférences de langue et d’apparence',
    language: 'Langue',
    english: 'English',
    french: 'Français',
  ...
  platform: {
    ...
    searchLabel: 'Rechercher des appels',
    searchPlaceholder: 'Rechercher par événement, organisation ou lieu',
    searchSummary: '{shown} résultat(s) parmi {loaded} chargé(s)',
    searchNoResults: 'Aucun appel chargé ne correspond à cette recherche.',
    searchClear: 'Effacer la recherche',
    searchClearFilter: 'Effacer le filtre',
    loadMore: 'Charger plus d’appels',
    loadingMore: 'Chargement…',
    searchMoreHelp: 'D’autres appels sont disponibles. Chargez la page suivante pour poursuivre la recherche.',
    blindReviewBadge: 'Évaluation à l’aveugle',
  ...
  transfer: {
    ...
    initiateTitle: 'Transférer la propriété',
    initiateHelp:
      'Choisissez un successeur vérifié pour devenir propriétaire de {scope}. Vous deviendrez administrateur une fois le transfert accepté.',
    emailLabel: 'Adresse courriel du successeur',
    emailHelp: 'Le destinataire doit déjà avoir un compte actif et vérifié.',
    initiateButton: 'Transférer la propriété',
    initiating: 'Transfert en cours…',
    confirmPrompt: 'Le transfert de propriété vous rétrogradera au rôle d’administrateur une fois accepté.',
    pendingBanner: (email: string) => `Transfert de propriété en attente vers ${email}`,
    pendingNotice: 'Un transfert est en attente. Le successeur doit se connecter pour l’accepter.',
    cancelButton: 'Annuler le transfert',
    cancelling: 'Annulation…',
    acceptTitle: 'Invitation de transfert de propriété',
    acceptBanner: (scopeName: string) =>
      `Vous avez été invité à devenir le propriétaire de : ${scopeName}. Accepter la propriété ?`,
    acceptButton: 'Accepter la propriété',
    accepting: 'Acceptation…',
    transferred: 'Propriété transférée avec succès.',
    cancelled: 'Transfert de propriété annulé.',
    accountNotReady: 'Cette personne doit d’abord créer et faire vérifier un compte actif.',
    alreadyOwner: 'Vous êtes déjà le propriétaire.',
    alreadyPending: 'Annulez le transfert de propriété en cours avant d’en commencer un autre.',
    notFound: 'Aucun transfert de propriété en attente trouvé pour ce compte.',
    notEligible: 'Le compte du successeur n’est pas admissible.',
    wrongAccount: 'Ce transfert n’était pas adressé à votre compte.',
    badInput: 'Vérifiez l’adresse courriel et réessayez.',
  },

  orgs: {
    title: 'Organisations',
    accountLink: 'Mes organisations',
    createTitle: 'Créer une organisation',
    createSubtitle: 'Organisez plusieurs événements, gérez les permissions d’équipe et personnalisez l’image de marque.',
    nameLabel: 'Nom de l’organisation',
    namePlaceholder: 'ex. PyCon Canada, Tech Conf Globale',
    slugLabel: 'Identifiant de l’organisation (adresse URL)',
    slugHelp: 'Utilisé dans l’URL du tableau de bord et de l’espace de travail.',
    initialOwnerLabel: 'Courriel du propriétaire initial',
    initialOwnerHelp: 'Le compte vérifié qui possédera et gérera cette organisation.',
    ownerByDefault: 'Vous deviendrez propriétaire de cette organisation.',
    createButton: 'Créer l’organisation',
    creating: 'Création en cours…',
    noOrgs: 'Vous ne faites partie d’aucune organisation pour le moment.',
    createFirstPrompt: 'Créez votre première organisation pour collaborer avec votre équipe et gérer plusieurs appels à propositions.',
    createRestrictedHelp:
      'Une personne administrant la plateforme peut créer une organisation et vous ajouter à son équipe.',
    createLimitHelp:
      'Vous possédez déjà une organisation. Transférez-en la propriété avant d’en créer une autre.',
    createFirstTitle: 'Créez d’abord une organisation',
    createFirstHelp:
      'Chaque événement appartient à une organisation. Créez-en une ou demandez à un propriétaire de vous ajouter comme administrateur.',
    eventLimitReached:
      'Cette organisation a atteint sa limite d’événements actifs. Archivez un événement ou demandez à un administrateur de la plateforme d’augmenter la limite.',
    yourRole: 'Votre rôle',
    roles: {
      owner: 'Propriétaire',
    ...
    workspaceTitle: 'Espace de travail de l’organisation',
    eventsTab: 'Événements & Appels',
    membersTab: 'Membres de l’équipe',
    settingsTab: 'Paramètres & Marque',
    sectionsLabel: 'Sections de l’organisation',
    newEventButton: 'Créer un nouvel appel pour cette organisation',
    noEvents: 'Aucun appel à propositions créé pour cette organisation pour l’instant.',
    noEventsHelp:
      'Créez le premier appel à propositions de cette organisation pour commencer à recevoir des soumissions.',
    eventActive: 'Actif',
    eventArchived: 'Archivé',
    website: 'Site web',
    personalEvent: 'Personnel / indépendant',
    inviteMemberTitle: 'Ajouter un membre d’équipe',
    inviteMemberHelp: 'Cette personne doit déjà avoir un compte actif et vérifié pour cette adresse courriel.',
    memberEmailLabel: 'Adresse courriel',
    memberRoleLabel: 'Rôle',
    inviteButton: 'Ajouter le membre',
    inviting: 'Ajout en cours…',
    memberAdded: 'Ajout de {email} à l’organisation terminé.',
    removingMember: 'Retrait…',
    memberRemoved: '{member} a été retiré de l’organisation.',
    membersListTitle: 'Membres actifs de l’équipe',
    removeMember: 'Retirer',
    removeMemberConfirm: (email: string) => `Retirer ${email} de cette organisation ?`,
    settingsTitle: 'Détails & image de marque de l’organisation',
    descriptionLabel: 'Description',
    websiteLabel: 'Site web',
    logoUrlLabel: 'URL du logo',
    saveSettings: 'Enregistrer les paramètres de l’organisation',
    savingSettings: 'Enregistrement…',
    settingsSaved: 'Paramètres de l’organisation enregistrés avec succès.',
    deleteTitle: 'Supprimer l’organisation',
    deleteHelp:
      'Supprimer définitivement cette organisation et ses membres. Tous les événements doivent d’abord être déplacés ou supprimés.',
    deleteButton: 'Supprimer l’organisation',
    deleteConfirm: (slug: string) => `Tapez "${slug}" pour confirmer la suppression :`,
    deleting: 'Suppression…',
    deleted: 'Organisation supprimée avec succès.',
    cancel: 'Annuler',
    closeCreate: 'Fermer le formulaire de création',
    breadcrumb: 'Organisations',
    viewWorkspace: 'Ouvrir l’espace',
    errors: {
      slugFormat: 'Utilisez uniquement des lettres minuscules, des chiffres et des tirets.',
      slugLength: 'Doit comporter entre 3 et 60 caractères.',
      taken: 'Cet identifiant d’organisation est déjà utilisé.',
      accountNotReady: 'Cette personne doit d’abord créer et vérifier un compte actif.',
      ownerProtected: 'Le rôle de propriétaire de l’organisation ne peut pas être modifié ici.',
      ownerRequired: 'Seul le propriétaire de l’organisation peut effectuer cette action.',
      hasEvents: 'Déplacez ou supprimez tous les événements avant de supprimer cette organisation.',
      deleteTooLarge: 'Cette organisation est trop volumineuse pour la suppression libre-service. Communiquez avec le soutien de la plateforme.',
      badInput: 'Vérifiez les renseignements de l’organisation et réessayez.',
      notFound: 'Cette organisation est introuvable.',
      generic: 'Impossible de terminer l’action sur l’organisation.',
    },
  },
  ...
  platformAdmin: {
    ...
    accountLink: 'Administration de la plateforme',
    eyebrow: 'Administration de la plateforme',
    intro:
      'Gérez les administrateurs de la plateforme, les limites d’événements des organisations et la livraison partagée des courriels. Les rôles des organisations et des événements restent distincts.',
    sections: 'Sections de l’administration de la plateforme',
    overviewNav: 'Vue d’ensemble',
    accessNav: 'Personnes et permissions',
    limitsNav: 'Limites d’utilisation',
    emailDefaultsNav: 'Livraison des courriels',
    overviewEyebrow: 'Centre de contrôle',
    overviewTitle: 'Choisissez une zone d’administration',
    overviewHelp:
      'Les contrôles de la plateforme sont regroupés par responsabilité afin de séparer clairement les permissions, les quotas et la livraison.',
    accessCardHelp: 'Propriétaire, administrateurs et transfert de propriété de la plateforme.',
    limitsCardHelp: 'Quotas de propriété des organisations et capacité d’événements actifs.',
    emailCardHelp: 'Service partagé, domaine vérifié, expéditeur et contrôles de livraison.',
    openSection: 'Ouvrir les réglages',
    accessTitle: 'Personnes et permissions',
    accessHelp:
      'Un accès à la plateforme ne permet jamais de consulter les espaces d’organisation, les comités d’événement, les propositions ou les évaluations. Son retrait ne supprime pas les événements que la personne possède déjà. Les accès aux organisations et aux événements doivent être accordés séparément.',
    activeTitle: 'Rôles de la plateforme',
    activeHelp: 'Accès actifs et invitations en attente d’une connexion vérifiée.',
    ...
    roleHelp: {
      owner:
        'L’unique propriétaire possède tous les droits d’un administrateur, gère les administrateurs de la plateforme et peut transférer la propriété.',
      admin:
        'Peut configurer les limites des comptes et des organisations ainsi que la livraison des courriels. Ne peut ni nommer d’administrateurs de la plateforme ni transférer la propriété.',
    },
    isYou: 'vous',
    empty: 'Aucun propriétaire ou administrateur de la plateforme pour le moment.',
    adminAddTitle: 'Ajouter un administrateur de la plateforme',
    adminAddHelp:
      'Les administrateurs peuvent configurer les limites d’utilisation et la livraison des courriels. Ils ne peuvent ni nommer d’autres administrateurs de la plateforme, ni transférer la propriété, ni accéder aux données d’une organisation ou d’un événement sans y recevoir un rôle distinct.',
    ...
    adminGrantedPending: (email: string) =>
      `${email} deviendra administrateur de la plateforme après une connexion vérifiée.`,
    adminRevoked: (email: string) =>
      `${email} n’est plus administrateur de la plateforme.`,
    transferTitle: 'Transférer la propriété de la plateforme',
    transferHelp:
      'Invitez un successeur vérifié à devenir le propriétaire unique de la plateforme. Après son acceptation, la propriété est transférée et vous devenez administrateur de la plateforme.',
    loadError: 'Impossible de charger les données d’administration de la plateforme.',
    badEmail: 'Saisissez une adresse courriel valide.',
    adminManaged:
      'Cet accès est protégé. Seul l’unique propriétaire gère les administrateurs, la propriété ne change que par un transfert accepté et personne ne peut retirer son propre accès.',
    ownerRequired: 'Seul le propriétaire de la plateforme peut effectuer cette action.',
    ...
    retry: 'Réessayer',
    limitsTitle: 'Limites d’utilisation',
    limitsHelp:
      'Les limites de compte déterminent combien d’organisations une personne peut posséder. Les limites d’organisation déterminent combien d’événements non archivés chacune peut exploiter.',
    globalLimitsTitle: 'Valeurs par défaut globales',
    globalLimitsHelp:
      'Ces valeurs s’appliquent lorsqu’aucune exception individuelle n’existe. Réduire la valeur par défaut ne supprime ni ne transfère une organisation existante; cela limite seulement les créations et acceptations futures.',
    globalLimitsDefaultEyebrow: 'Référence de la plateforme',
    globalLimitsOwnershipTitle: 'Organisations par utilisateur',
    globalLimitsOwnershipHelp:
      'Chaque compte vérifié sans exception individuelle utilise cette limite de propriété.',
    globalLimitsSave: 'Enregistrer la valeur',
    globalLimitsSaving: 'Enregistrement…',
    globalLimitsSaved: 'La limite globale de propriété des organisations a été enregistrée.',
    globalLimitsLoadError: 'Impossible de charger les limites globales.',
    globalLimitsSaveError: 'Impossible d’enregistrer la limite globale de propriété.',
    userLimitsTitle: 'Propriété d’organisations par utilisateur',
    userLimitsHelp:
      'Les comptes utilisent la valeur globale par défaut sauf si une exception est définie. Une exception ne touche que les créations et acceptations futures; elle ne supprime ni ne transfère une organisation existante.',
    userLimitsLoadError: 'Impossible de charger les limites d’organisation des utilisateurs.',
    userLimitsEmpty: 'Aucun propriétaire d’organisation ni exception individuelle pour le moment.',
    userLimitsSearchLabel: 'Trouver un compte vérifié',
    userLimitsSearchPlaceholder: 'Courriel exact du compte',
    userLimitsSearchAction: 'Trouver le compte',
    userLimitsSearchClear: 'Retour au répertoire',
    userLimitsLookupError: 'Aucun compte vérifié et actif n’utilise cette adresse courriel.',
    userLimitsNoResults: 'Aucun compte ne correspond à cette adresse courriel.',
    userLimitLabel: 'Limite de propriété d’organisations',
    userLimitUsage: '{owned} possédée(s) sur {limit} permise(s)',
    userLimitDefault: 'valeur par défaut',
    userLimitSave: 'Enregistrer la limite',
    userLimitSaving: 'Enregistrement…',
    userLimitSaved: 'La limite d’organisation de {email} a été enregistrée.',
    userLimitReset: 'Utiliser la valeur par défaut',
    userLimitResetting: 'Réinitialisation…',
    userLimitResetDone: '{email} utilise maintenant la valeur par défaut.',
    userLimitSaveError:
      'Impossible d’enregistrer la limite. Vérifiez que le compte existe, est confirmé et est actif.',
    userLimitInvalid: 'Saisissez un nombre entier de 0 à {max}.',
    paginationLabel: 'Pages de la liste',
    paginationRange: '{start} à {end} sur {total}',
    paginationPage: 'Page {current} sur {total}',
    paginationCurrent: 'Page {current}',
    paginationPrevious: 'Précédente',
    paginationNext: 'Suivante',
    orgLimitsTitle: 'Limites d’événements des organisations',
    orgLimitsHelp:
      'Chaque organisation commence avec un événement actif. Les événements archivés ne comptent pas. Réduire une limite n’archive aucun événement; cela bloque seulement les nouvelles créations jusqu’à ce que l’utilisation redescende sous la limite.',
    orgLimitsLoadError: 'Impossible de charger les limites des organisations.',
    orgLimitsEmpty: 'Aucune organisation n’a encore été créée.',
    orgLimitsSearchLabel: 'Trouver une organisation',
    orgLimitsSearchPlaceholder: 'Début de l’identifiant',
    orgLimitsSearchAction: 'Rechercher',
    orgLimitsSearchClear: 'Tout afficher',
    orgLimitsNoResults: 'Aucune organisation ne correspond à ce filtre.',
    orgLimitLabel: 'Limite d’événements actifs',
    orgLimitUsage: '{active} actif(s) sur {limit} permis',
    orgLimitSave: 'Enregistrer la limite',
    orgLimitSaving: 'Enregistrement…',
    orgLimitSaved: 'La limite d’événements de {name} a été enregistrée.',
    orgLimitSaveError: 'Impossible d’enregistrer la limite de l’organisation.',
    orgLimitInvalid: 'Saisissez un nombre entier de 0 à {max}.',
    emailDefaultsTitle: 'Livraison des courriels de la plateforme',
    emailDefaultsIntro:
      'Configurez le domaine vérifié et l’expéditeur dont les événements peuvent hériter. Un événement peut utiliser sa propre configuration de livraison et conserve toujours le contrôle de ses textes.',
    emailDefaultsLoadError: 'Impossible de charger les réglages de livraison de la plateforme.',
  ...
  admin: {
    ...
    people: 'Comité',
    peopleHelp:
      'Ajoutez par courriel. Un compte vérifié devient actif immédiatement; sinon, l’invitation attend une connexion vérifiée.',
    ...
    ownerRequired: 'Seul le propriétaire de l’événement peut effectuer cette action.',
    inviteLinks: 'Liens d’invitation',
    inviteLinksHelp:
      'Générez un lien partageable pour attribuer automatiquement un rôle dès la connexion ou l’inscription.',
    createInviteLink: 'Créer un lien',
    creatingInviteLink: 'Création…',
    inviteLinkGenerated: 'Lien d’invitation créé et copié dans le presse-papiers.',
    inviteLinkLabel: 'Libellé / Note (facultatif)',
    inviteLinkLabelPlaceholder: 'ex. Évaluateurs Discord',
    inviteLinkMaxClaims: 'Limite d’utilisations (facultatif)',
    inviteLinkMaxClaimsPlaceholder: 'Laisser vide pour illimité',
    inviteLinkExpiry: 'Expiration',
    inviteLinkExpiryNever: 'N’expire jamais',
    inviteLinkExpiry7d: '7 jours',
    inviteLinkExpiry14d: '14 jours',
    inviteLinkExpiry30d: '30 jours',
    inviteLinkExpiryCustom: 'Date personnalisée',
    inviteLinkCustomDate: 'Expire le',
    inviteLinkCopy: 'Copier le lien',
    inviteLinkCopied: 'Copié !',
    inviteLinkRevoke: 'Révoquer',
    inviteLinkRevokeConfirm:
      'Révoquer ce lien d’invitation ? Il n’acceptera plus aucune nouvelle utilisation immédiatement.',
    inviteLinkRevoked: 'Lien d’invitation révoqué.',
    noInviteLinks: 'Aucun lien d’invitation créé pour le moment.',
    inviteLinkClaims: (count: number, max: number | null) =>
      max ? `${count} / ${max} utilisations` : `${count} utilisations`,
    inviteLinkStatus: {
      active: 'Actif',
      expired: 'Expiré',
      exhausted: 'Complet',
    ...
    ownershipScope: 'cet appel à conférences',
    identityHelp:
    ...
    themeTitle: 'Thème et options d’évaluation',
    themeHelp: 'Personnalisez les couleurs de la marque et le processus d’évaluation pour cet événement.',
    blindReview: 'Activer l’évaluation à l’aveugle',
    blindReviewHelp:
      'Masque le nom, la biographie, l’entreprise, la ville et les informations de voyage pendant la notation.',
  ...
  review: {
    blindReviewActive: 'Évaluation à l’aveugle active',
  ...
  join: {
    title: 'Rejoindre le comité',
    heading: (event: string, role: string) => `Rejoindre ${event} en tant que ${role}`,
    invitedNotice: (role: string) =>
      `Vous avez été invité à rejoindre le comité de cet événement en tant que ${role}.`,
    signInPrompt: (event: string, role: string) =>
      `Connectez-vous avec votre compte Google ou votre courriel pour rejoindre ${event} en tant que ${role}.`,
    acceptButton: (role: string) => `Accepter et rejoindre comme ${role}`,
    joining: 'Adhésion au comité en cours…',
    alreadyMember: (role: string) => `Vous détenez déjà le rôle de ${role} pour cet événement.`,
    goToReview: 'Accéder aux évaluations',
    goToAdmin: 'Gérer l’événement',
    expiredTitle: 'Invitation expirée',
    expiredHelp: 'Ce lien d’invitation a expiré et n’accepte plus de nouveaux membres.',
    exhaustedTitle: 'Limite d’utilisations atteinte',
    exhaustedHelp: 'Le nombre maximal de personnes a déjà utilisé ce lien d’invitation.',
    revokedTitle: 'Invitation révoquée',
    revokedHelp: 'Ce lien d’invitation a été révoqué par l’organisateur.',
    invalidTitle: 'Invitation invalide',
    invalidHelp: 'Ce lien d’invitation est invalide ou n’existe plus.',
    successToast: (role: string) => `Vous avez rejoint le comité en tant que ${role} !`,
  },
  errors: {
