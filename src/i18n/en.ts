...
export const en = {
  ...
  form: {
    ...
    statusHelp: {
      ...
      confirmed: 'You are confirmed. Schedule details will appear here after organisers publish them.',
  ...
  schedule: {
    ...
    adminHelp:
      'Place accepted talks privately, resolve flexible languages, then publish one stable agenda.',
    ...
    unassignedHelp: 'Accepted talks can be planned here; only confirmed talks can be published.',
    ...
    publishBlocked: 'Every proposal session must be confirmed and conflict-free before publishing.',
