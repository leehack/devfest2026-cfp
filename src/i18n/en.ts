...
export const en = {
  ...
  admin: {
    ...
    inviteLinksHelp:
      'Generate a shareable link to automatically assign a role upon sign-in or registration.',
    createInviteLink: 'Create link',
    creatingInviteLink: 'Creating link…',
    inviteLinkGenerated: 'Invitation link created and copied to clipboard.',
    inviteLinkLabel: 'Label / Note (optional)',
    inviteLinkLabelPlaceholder: 'e.g. Discord reviewers',
    inviteLinkMaxClaims: 'Claim limit (optional)',
    inviteLinkMaxClaimsPlaceholder: 'Leave empty for unlimited',
    inviteLinkExpiry: 'Expiration',
    inviteLinkExpiryNever: 'Never expires',
    inviteLinkExpiry7d: '7 days',
    inviteLinkExpiry14d: '14 days',
    inviteLinkExpiry30d: '30 days',
    inviteLinkExpiryCustom: 'Custom date',
    inviteLinkCustomDate: 'Expires on',
    inviteLinkCopy: 'Copy link',
    inviteLinkCopied: 'Copied!',
    inviteLinkRevoke: 'Revoke',
    inviteLinkRevokeConfirm:
      'Revoke this invitation link? It will immediately stop accepting new claims.',
    inviteLinkRevoked: 'Invitation link revoked.',
    noInviteLinks: 'No invitation links created yet.',
    inviteLinkClaims: (count: number, max: number | null) =>
      max ? `${count} / ${max} claims` : `${count} claims`,
    inviteLinkStatus: {
      active: 'Active',
      expired: 'Expired',
      exhausted: 'Full',
  ...
  review: {
    ...
    deckCompletedTitle: 'You’re all caught up!',
    deckCompletedHelp: 'Every proposal in this view has a response.',
    browseAllProposals: 'Browse all proposals',
    ...
    scoreHelp:
      'Choosing a score (1–4) or declaring a conflict (0) saves this review and moves to the next proposal.',
    scores: {
      0: '0 — Conflict',
      1: '1 — Pass',
      2: '2 — Maybe',
    ...
    rubric: {
      0: 'Recuse: personal or professional connection. Excluded from totals and calibration.',
    ...
    shortcuts: 'Shortcuts',
    shortcutScore: 'Score (1–4) or conflict (0), and move to the next one',
  ...
  join: {
    ...
    heading: (event: string, role: string) => `Join ${event} as a ${role}`,
    invitedNotice: (role: string) =>
      `You have been invited to join this event’s committee as a ${role}.`,
    signInPrompt: (event: string, role: string) =>
      `Sign in with your Google account or email to join ${event} as a ${role}.`,
    acceptButton: (role: string) => `Accept & Join as ${role}`,
    joining: 'Joining committee…',
    alreadyMember: (role: string) => `You already hold the ${role} role for this event.`,
    goToReview: 'Go to Review talks',
    goToAdmin: 'Go to Manage event',
    expiredTitle: 'Invitation expired',
    expiredHelp: 'This invitation link has expired and is no longer accepting new committee members.',
    exhaustedTitle: 'Claim limit reached',
    exhaustedHelp: 'The maximum number of people have already claimed this invitation link.',
    revokedTitle: 'Invitation revoked',
    revokedHelp: 'This invitation link has been revoked by the event organizer.',
    invalidTitle: 'Invalid invitation',
    invalidHelp: 'This invitation link is not valid or no longer exists.',
    successToast: (role: string) => `You have joined the committee as a ${role}!`,
  },
  errors: {
