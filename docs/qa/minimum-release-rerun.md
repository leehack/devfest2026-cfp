...
| `PLT-03` | Verified account → `/orgs`, button `Create an organization`; a second organization is refused at the default limit. Platform admin → `/platform/limits`, search for the account and save an override of `2`; account retries and creates the second organization. | No — default quota, refusal, searchable override, successful retry |
...
| `PLT-02` · `VERIFIED-USER → organization/event owner` · `MT` | `organizations.spec.ts`; `platform.spec.ts` — organization and event creation flows | Create an organization and the disposable CFP, then verify both owner workspaces and the resumable home task. | `verified-user/plt-02--organization-created--desktop-1440x1000.png`<br>`verified-user/plt-02--created-event--desktop-1440x1000.png`<br>`verified-user/plt-02--home-task-card--desktop-1440x1000.png` |
| `PLT-03` · `PLATFORM-ADMIN + USER-LIMIT-TARGET` · `MX` | `platformAccess.spec.ts`; `organizations.spec.ts` — account limit override flow | Search for the verified account, set an organization ownership override, prove creation follows the new limit, then prove the platform admin is denied an unrelated event. | `platform-admin/plt-03--account-search--desktop-1440x1000.png`<br>`platform-admin/plt-03--saved-override--desktop-1440x1000.png`<br>`platform-admin/plt-03--retained-ownership--desktop-1440x1000.png`<br>`platform-admin/plt-03--unrelated-event-denial--desktop-1440x1000.png` |
