 ...
 * instance starts. A platform admin can then rotate the key from `/admin` and
 * the next instance picks it up, with no deploy and nothing pasted into a terminal.
 */
